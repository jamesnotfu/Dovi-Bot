    ...
    public Dovi() {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if (uText.contains("L")) {
                ...
                if (decider == 1) {
                    botSay("I'm the greatest teacher of all time.");
                }
                else if (decider == 2) {
                    botSay("I'm great. How are YOU?");
                }
                else if (decider == 3) {
                    botSay("I'm doing better than you.");
               }
            }
            ...
            else if (uText.contains("analyze")) {
                List<String> grades = IcLogin.getGrades();
                botSay("Things aren't looking too good right now. Your grades are as follows: ");
                for(int i = 0; i < grades.size(); i++) {
                    txtChat.append("      Class " + i + ": " + grades.get(i) + "\n");
                }
                botSay("Do not fret! If you watch my videos and subscribe to me on YouTube you'll do great. ");
            }  
            else {
                randomResponse();
            }
